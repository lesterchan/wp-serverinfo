 ...
 */
function wp_serverinfo_test_source_files() {
 ...
 * use, so "does the GD probe still scrape phpinfo()?" would match the docblock
 ...
 * @return string
 */
function wp_serverinfo_test_source_code( array $skip = array() ) {
	$code = '';
 ...
 * @return string
 */
function wp_serverinfo_test_read( $relative ) {
